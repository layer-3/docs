 ...
 * Modifications:
 *   - The chevron button (.menu__caret) is the only click target that toggles
 *     a category. Clicking the label text either navigates (if href) or does
 *     nothing (if no href).
 *   - The chevron is rendered for both href and non-href collapsible categories.
 */
...
function DocSidebarItemCategoryCollapsible({
  ...
  // Label click: navigate if href, otherwise do nothing.
  // Toggling is handled exclusively by the chevron button.
