...
Comprehensive checklist for building a compliant <Tooltip content={tooltipDefinitions.virtualAppProtocol}>VirtualApp</Tooltip> client with security best practices.
...
Foundation requirements for any <Tooltip content={tooltipDefinitions.virtualAppProtocol}>VirtualApp</Tooltip> implementation.
...
- [ ] **Compute <Tooltip content={tooltipDefinitions.channelId}>channelId</Tooltip> from Channel struct**
  ...
  - Reference: [Data Structures](./app-layer/on-chain/data-structures#channel-identifier)
...
- [ ] **Compute payload hash (packedState) from channel state**
  ...
  - Reference: [Data Structures](./app-layer/on-chain/data-structures#packed-state)
...
- [ ] **Create channel (`Custody.create`)**
  ...
  - Reference: [Channel Lifecycle](./app-layer/on-chain/channel-lifecycle#creation-phase)
...
- [ ] **Cooperative closure (`Custody.close`)**
  ...
  - Reference: [Channel Lifecycle](./app-layer/on-chain/channel-lifecycle#closure---cooperative)
...
- [ ] **Dispute / challenge**
  ...
  - Reference: [Channel Lifecycle](./app-layer/on-chain/channel-lifecycle#closure---challenge-response)
...
- [ ] **Establish RPC connection**
  ...
  - Reference: [Off-Chain Overview](./app-layer/off-chain/overview)
...
- [ ] **Implement message format**
  ...
  - Reference: [Message Format](./app-layer/off-chain/message-format)
...
- [ ] **Implement 3-step flow (auth_request → auth_challenge → auth_verify)**
  ...
  - Reference: [Authentication](./app-layer/off-chain/authentication)
...
- [ ] **Implement all required methods**
  ...
  - Reference: [Queries](./app-layer/off-chain/queries)
...
- [ ] **Handle server notifications**
  ...
  - Reference: [Notifications](./app-layer/off-chain/queries#notifications-server-to-client)
...
- [ ] **Handle app session state updates**
  ...
  - Reference: [App Sessions](./app-layer/off-chain/app-sessions)
...
- [ ] **Handle error responses**
  ...
  - Reference: [Error Response](./app-layer/off-chain/message-format#error-response)
...
- **Channel Lifecycle**: [Channel Lifecycle](./app-layer/on-chain/channel-lifecycle)
- **RPC Methods**: [Queries](./app-layer/off-chain/queries)
