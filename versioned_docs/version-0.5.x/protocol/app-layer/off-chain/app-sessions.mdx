...
### Example 4: Weighted Multi-Party Voting
...
**Governance**: Weighted majority - decisions require majority approval by weight.
...
- Withdraw partial winnings from a shared session
- Reduce wager in ongoing game
