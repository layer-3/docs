...
- **[Message Format](../../protocol/app-layer/off-chain/message-format.mdx)** — Full format specification
- **[Off-Chain Overview](../../protocol/app-layer/off-chain/overview.mdx)** — Protocol architecture
- **[Implementation Checklist](../../protocol/implementation-checklist.mdx#off-chain-rpc)** — Building RPC support
