...
- **[Authentication Flow](../../protocol/app-layer/off-chain/authentication.mdx)** — Full 3-step authentication protocol
- **[Communication Flows](../../protocol/communication-flows.mdx#authentication-flow)** — Sequence diagrams for auth
