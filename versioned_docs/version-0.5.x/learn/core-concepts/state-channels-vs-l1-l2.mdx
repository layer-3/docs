...
keywords: [state channels, L1, L2, scaling, comparison, rollups, VirtualApp]
---
...
- **[Architecture](../../protocol/architecture)** — System design and fund flows
- **[Channel Lifecycle](../../protocol/app-layer/on-chain/channel-lifecycle.mdx)** — State machine and operations
- **[Data Structures](../../protocol/app-layer/on-chain/data-structures.mdx)** — Channel and state formats
