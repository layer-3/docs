...
| **Weighted Voting** | `weights: [20, 25, 30, 25]`, `quorum: 51` | Majority by weight |
...
- **[App Session Methods](../../protocol/app-layer/off-chain/app-sessions.mdx)** — Complete method specifications
- **[Communication Flows](../../protocol/communication-flows.mdx#app-session-lifecycle-flow)** — Sequence diagrams
- **[Implementation Checklist](../../protocol/implementation-checklist.mdx#state-management)** — Building app session support
