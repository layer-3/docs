...
The VirtualApp SDK provides a higher-level abstraction for managing session keys. For detailed information on using session keys with the VirtualApp SDK, please refer to the SDK documentation.
