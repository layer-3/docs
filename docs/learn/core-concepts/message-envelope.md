...
- **[Message Format](/docs/protocol/off-chain/message-format)** — Full format specification
- **[Off-Chain Overview](/docs/protocol/off-chain/overview)** — Protocol architecture
- **[Implementation Checklist](/docs/protocol/implementation-checklist#off-chain-rpc)** — Building RPC support
