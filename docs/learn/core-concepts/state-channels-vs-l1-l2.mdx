...
- **[Channel Lifecycle](/docs/protocol/app-layer/on-chain/channel-lifecycle.mdx)** — State machine and operations
- **[Data Structures](/docs/protocol/app-layer/on-chain/data-structures.mdx)** — Channel and state formats
