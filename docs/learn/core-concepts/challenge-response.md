...
- **[Channel Lifecycle](/docs/protocol/on-chain/channel-lifecycle)** — Full state machine
- **[Security Considerations](/docs/protocol/on-chain/security)** — Threat model and best practices
- **[Communication Flows](/docs/protocol/communication-flows#challenge-response-closure-flow)** — Sequence diagrams
