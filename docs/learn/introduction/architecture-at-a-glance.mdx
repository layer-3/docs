...
:::info Legacy Flow
The diagram above shows the flow where both participants sign the initial state, creating the channel directly in ACTIVE status. See the [Channel Lifecycle](/docs/protocol/app-layer/channel-lifecycle) section for details.
:::
