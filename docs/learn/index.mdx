...
**[Prerequisites & Environment](./getting-started/prerequisites.mdx)** — Set up a complete development environment with Node.js, TypeScript, and the VirtualApp SDK.
...
|-------|------|------------|
| [What Yellow Solves](./introduction/what-yellow-solves.mdx) | 5 min | Beginner |
| [Architecture at a Glance](./introduction/architecture-at-a-glance.mdx) | 8 min | Beginner |
| [Quickstart](./getting-started/quickstart.mdx) | 10 min | Beginner |
| [Key Terms](./getting-started/key-terms.mdx) | 10 min | Beginner |
| [State Channels vs L1/L2](./core-concepts/state-channels-vs-l1-l2.mdx) | 12 min | Intermediate |
| [App Sessions](./core-concepts/app-sessions.mdx) | 8 min | Intermediate |
| [Session Keys](./core-concepts/session-keys.mdx) | 8 min | Intermediate |
| [Challenge-Response](./core-concepts/challenge-response.mdx) | 6 min | Intermediate |
| [Message Envelope](./core-concepts/message-envelope.mdx) | 5 min | Intermediate |
