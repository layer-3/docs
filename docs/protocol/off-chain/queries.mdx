...
| `get_channels` | Public/Private | List payment channels | Yes |
...
|-----------|------|----------|-------------|---------|---------|
| `participant` | string | No | Participant wallet address to query | Authenticated user | `"0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb"` |
| `status` | string | No | Filter by status | - | `"active"` |
| `offset` | number | No | Pagination offset | `0` | `42` |
| `limit` | number | No | Number of channels to return | `100` | `10` |
...
| `account_type` | number | Type of account (0=Unified, 1=App Session, 2=Channel Escrow) | `0` |
...
| Field | Type | Description | Example |
|-------|------|-------------|---------|
| `id` | string | Unique transaction identifier | `"1"` |
| `tx_type` | string | Transaction type | `"transfer"` |
| `from_account` | string | Sender wallet address | `"0x742d35Cc..."` |
| `from_account_tag` | string | Sender's user tag (empty if none) | `"NQKO7C"` |
| `to_account` | string | Receiver wallet address | `"0x8B3192f2..."` |
...
| `allowances` | array\<Allowance\> | Spending limits and usage | — | See Allowance structure below |
...
| Field | Type | Description | Example |
|-------|------|-------------|---------|
| `account_id` | string | Account identifier | `"0x742d35Cc..."` |
| `asset` | string | Asset symbol | `"usdc"` |
