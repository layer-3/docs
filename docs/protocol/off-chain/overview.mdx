...
- <Tooltip content={tooltipDefinitions.stateHash}>State hashes</Tooltip>
...
- `channel_update` - <Tooltip content={tooltipDefinitions.channel}>Channel</Tooltip> status changed
- `transfer_received` - Incoming transfer
- `app_session_update` - <Tooltip content={tooltipDefinitions.appChannel}>App session</Tooltip> state changed
