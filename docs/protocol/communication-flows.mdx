...
- **Client**: User application or SDK
- **Clearnode**: Off-chain service provider
- **Smart Contract**: <Tooltip content="The main on-chain contract implementing channel creation, joining, closure, and resizing. It is an implementation of the Nitrolite protocol">Custody Contract</Tooltip>
...
- Transfers tokens from user to <Tooltip content="The main on-chain contract implementing channel creation, joining, closure, and resizing. It is an implementation of the Nitrolite protocol">Custody</Tooltip>
...
- Transfers tokens from clearnode to <Tooltip content="The main on-chain contract implementing channel creation, joining, closure, and resizing. It is an implementation of the Nitrolite protocol">Custody</Tooltip> (0 in this case)
