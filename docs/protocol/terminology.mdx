...
**Participant**: An entity (identified by a wallet address) that is part of a channel. Typically includes a Creator (user) and Clearnode.
...
**chainId**: A blockchain network identifier (uint32). Examples: 1 (Ethereum Mainnet), 137 (Polygon), 8453 (Base), 42161 (Arbitrum One), 10 (Optimism).

**assetSymbol**: A lowercase string identifier for a supported asset (e.g., "usdc", "eth", "usdt", "dai"). Asset symbols are consistent across chains.
