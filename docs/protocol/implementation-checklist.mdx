...
- [ ] **Cooperative closure (`Custody.close`)**
  ...
  - Reference: [Channel Lifecycle](./app-layer/on-chain/channel-lifecycle#cooperative-closure)
...
- [ ] **Dispute / challenge**
  ...
  - Reference: [Channel Lifecycle](./app-layer/on-chain/channel-lifecycle#challenge-phase)
