...
The legacy state hash concept was removed in v0.3.0 when non-ECDSA signatures were introduced. Instead, participants sign the **packed state** payload directly:
