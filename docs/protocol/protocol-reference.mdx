...
Jump to a section:
- [Protocol Versions](#protocol-versions) - VirtualApp & Nitro RPC versions
...
4. **Channel Lifecycle**: See [Channel Lifecycle](./app-layer/on-chain/channel-lifecycle) for detailed state transitions
