...
- **Off-chain funds integrity**: Current off-chain validation depends on Node behavior to prevent unsupported state advancement before every path is enforced on-chain.
