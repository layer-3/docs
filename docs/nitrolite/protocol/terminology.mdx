...
| Channel Status | A specific on-chain channel data configuration throughout the lifecycle. The current RPC status surface is `void`, `open`, `challenged`, and `closed`. |
