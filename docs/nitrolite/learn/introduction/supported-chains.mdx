...
| `usdt` | Not listed. | Tether USD, 6 unified decimals. Available on Ethereum `1`, Flare `14`, BSC `56`, Polygon `137`, Base `8453`, Linea `59144`, and XRPL EVM `1440000`. |
| `xrp` | XRP, 18 unified decimals. Available on XRPL EVM Testnet `1449000`. | XRP, 6 unified decimals. Available on Flare `14` and XRPL EVM `1440000`. |
| `yellow` | Yellow, 18 decimals. Available on Ethereum Sepolia `11155111`. | Yellow, 18 decimals. Available on Ethereum `1`. |
| `yusd` | Yellow USD, 6 unified decimals. Available on Linea Sepolia `59141`, Polygon Amoy `80002`, Base Sepolia `84532`, XRPL EVM Testnet `1449000`, and Ethereum Sepolia `11155111`. | Not listed. |
